...
const ROWS = [
  { q: "Chiefs to win Super Bowl LX", crowd: 62, yours: 65, result: "HIT" },
  { q: "LeBron scores 30+ tonight", crowd: 38, yours: 35, result: "HIT" },
  { q: "Jones retains heavyweight title", crowd: 71, yours: 80, result: "HIT" },
  { q: "Dodgers win the World Series", crowd: 55, yours: 45, result: "MISS" },
];
        ...
        <div style={{ flex: 1, padding: "20px 60px", display: "flex", flexDirection: "column", gap: 10 }}>
          {ROWS.map((r) => (
            <div key={r.q} style={{ display: "flex", alignItems: "center", background: "#161620", borderRadius: 8, padding: "0 24px", height: 72, gap: 16 }}>
              <span style={{ color: r.result === "HIT" ? "#4cff88" : "#ff6666", fontSize: 18, fontWeight: 900, width: 56 }}>{r.result}</span>
